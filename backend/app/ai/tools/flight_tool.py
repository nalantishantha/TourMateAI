...
def search_flights(query: str, limit: int = 10) -> str:
    """Search for live flight information based on a natural language query.
    Extracts origin and destination from the query to find flights.
    """
    if not API_KEY:
        return (
...
if __name__ == "__main__":
    print(search_flights("Plan a 7 days Sri Lanka trip from Bangladesh"))
    print("\n" + "=" * 80 + "\n")
